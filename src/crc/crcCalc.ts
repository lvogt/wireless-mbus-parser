...
export function calcCrc(data: Buffer, start: number, end: number) {
  let crc = 0;
...
export function checkCrc(data: Buffer, start: number, end: number) {
  const checksum = calcCrc(data, start, end);
